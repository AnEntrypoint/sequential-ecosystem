...
if (args.length < 1) {
  console.error('Usage: task <task-name> [input-json]');
  console.error('');
  console.error('Examples:');
  console.error('  task hello-world \'{}\'');
  console.error('  task hello-world \'{"key":"value"}\'');
  console.error('  echo \'{"key":"value"}\' | task hello-world');
  process.exit(1);
}
...
async function runTask() {
  try {
    ...
    const apiUrl = `${serverUrl}/api/tasks/${taskName}/execute`;
