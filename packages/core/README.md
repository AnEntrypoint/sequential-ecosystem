...
**Note**: Validation functionality has been moved to `validation` package for better separation of concerns.
...
```javascript
import { response } from '@sequential/core';
import { validateRequired, validateInputSchema } from 'validation';
