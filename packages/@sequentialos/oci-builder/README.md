...
```bash
npm install @sequentialos/oci-builder
```
...
```javascript
import { Image, pack, CustomFile } from '@sequentialos/oci-builder';
...
```javascript
import { CustomFile } from '@sequentialos/oci-builder';
...
```javascript
import { RegistryClient } from '@sequentialos/oci-builder';
