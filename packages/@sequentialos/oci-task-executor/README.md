# @sequentialos/oci-task-executor
...
```bash
npm install @sequentialos/oci-task-executor
```
...
```javascript
import { buildImage } from '@sequentialos/oci-task-executor';
...
```javascript
import { runContainer } from '@sequentialos/oci-task-executor';
...
```javascript
import { pushImage } from '@sequentialos/oci-task-executor';
...
```javascript
import { getImageMetadata } from '@sequentialos/oci-task-executor';
...
- `@sequentialos/oci-builder` - Native OCI image building
- `@sequentialos/sequential-logging` - Logging utilities
