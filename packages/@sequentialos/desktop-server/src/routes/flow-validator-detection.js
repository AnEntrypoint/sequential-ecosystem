export function detectLoops(flow, statesArray, validation) {
...
export function detectTimeoutRaces(statesArray, validation) {
...
export function detectCompensationIssues(statesArray, validation) {
...
export function validateParallelJoins(statesArray, validation) {
