/**
 * Task Explorer App - HTML Template Module
 * DOM structure with CSS and JavaScript for the task explorer interface
 */
  ...
  <div class="app-container">
    <div class="header">
      ...
      <div class="search-box">
        ...
        <button onclick="window.refreshTasks()">Refresh</button>
      </div>
    </div>
