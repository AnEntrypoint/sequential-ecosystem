...
SQLite file-based storage backend for `sequential-runner` via `sequential-adaptor`.
...
This package extends `sequential-adaptor` with SQLite-specific storage:
...
- **sequential-adaptor-supabase** - Production Supabase backend
