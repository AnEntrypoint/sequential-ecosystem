export class ComponentPatternLibrary {
  ...
  registerAuthPatterns() {
    this.registry.register('login-form', `
    ...
    this.registry.register('signup-form', `
      <div style="max-width: 400px; margin: 0 auto; padding: 32px;">
  ...
  registerSearchPatterns() {
    this.registry.register('search-bar', `
    ...
    this.registry.register('search-results', `
  ...
  registerListPatterns() {
    this.registry.register('list-with-avatars', `
    ...
    this.registry.register('expandable-list', `
      <div style="display: flex; flex-direction: column; gap: 8px;">
  ...
  registerFormPatterns() {
    this.registry.register('form-section', `
    ...
    this.registry.register('form-with-help', `
      <div style="display: flex; flex-direction: column; gap: 8px;">
  ...
  registerCardPatterns() {
    this.registry.register('card-with-image', `
    ...
    this.registry.register('card-with-badge', `
    ...
    this.registry.register('stat-card-detailed', `
  ...
  registerModalPatterns() {
    this.registry.register('alert-dialog', `
    ...
    this.registry.register('toast-notification', `
  ...
  registerAdvancedPatterns() {
    this.registry.register('filter-panel', `
    ...
    this.registry.register('timeline', `
    ...
    this.registry.register('wizard-stepper', `
