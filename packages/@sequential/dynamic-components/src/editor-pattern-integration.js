...
class EditorPatternIntegration {
  constructor() {
  ...
  selectPattern(patternId) {
    ...
    this.emit('pattern-selected', this.selectedPattern);
  ...
  insertPattern(patternId, position = 'append') {
    ...
    this.emit('pattern-inserted', insertion);
    return insertion;
  }
  ...
  buildInsertedPatternsPanel() {
    return {
      ...
      children: [
        ...
        ...this.insertedPatterns.map((insertion, idx) => ({
          type: 'flex',
          direction: 'row',
          gap: '12px',
          style: {
...
function createEditorPatternIntegration() {
  return new EditorPatternIntegration();
}

export { EditorPatternIntegration, createEditorPatternIntegration };
