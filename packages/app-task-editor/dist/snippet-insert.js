...
// Consolidated from @sequentialos/editor-snippets
...
function createModal(onSearch, onSelect, onClose) {
...
function updateList(snippets, query, onSelect) {
...
function initSnippetInsert(editorId = 'codeEditor') {
